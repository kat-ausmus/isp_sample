...
class NotificationTask extends TimerTask {
    ...
    private void notifySubscribers(){
        ...
        subscriptionList.subscriptions.each { subscription ->
            ...
            def subscribersDataPlan = getListOfSubscribersDataPlan(subscription, dataPlanList)
    ...
    def getListOfSubscribersDataPlan (subscription, dataPlanList){

        return dataPlanList.plans.findAll { dataPlan ->
